...
extension UITextView {
    func setHtmlText(_ text: String?, theme: Theme.LabelStyle, color: UIColor = .black) {
        ...
        guard let attributedString = text?.convertHtmlToAttributedStringWithCSS(font: theme.textStyle.font, italicFont: italicFont, bulletTextFont: theme.textStyle.font, csscolor: color.getHexString()) else {
